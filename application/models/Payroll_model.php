...
class Payroll_model extends CI_Model {
	...
	{
		$this->db->select('tbl_slvl.id as id, tbl_slvl.employee_number as employee_number, tbl_slvl.type as type, tbl_slvl.effective_date_start as effective_date_start, tbl_slvl.effective_date_end as effective_date_end, tbl_slvl.reason as reason, tbl_slvl.status as status, tbl_slvl.type_name as type_name, tbl_slvl.sl_am_pm as sl_am_pm');
		$this->db->from('tbl_slvl');
	...
	{
		$this->db->select('tbl_ot.employee_number as ot_employee_number, SUM(tbl_ot.ot_num) as total_ot, tbl_ot.ot_type as ot_type');
		$this->db->from('tbl_ot');
	...
	{
		$this->db->select('tbl_slvl.employee_number as slvl_employee_number, SUM(tbl_slvl.slvl_num) as total_slvl, tbl_slvl.type as slvl_type');
		$this->db->from('tbl_slvl');
		$this->db->group_by('employee_number');
		$this->db->where('tbl_slvl.date >=', $start_date);
		$this->db->where('tbl_slvl.date <=', $end_date);
