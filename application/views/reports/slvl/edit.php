	...
	<div class="col-sm-8">
	  <div class="panel panel-primary">
	    ...
	    <div class="panel-body">
	    	...
	    	<br><br><br>
	    	<form method="POST" action="<?php echo base_url(); ?>index.php/reports/edit_slvl/<?php echo $slvl->id; ?>">
	              ...
	              <select class="form-control" name="name">
	              	...
	              	<?php if($employees) : ?>
	              		<?php foreach($employees as $emp) : ?>
	              			<option value="<?php echo $emp->name . '|' . $emp->employee_number; ?>"<?php echo $emp->employee_number== $slvl->employee_number ? 'selected' : '';?> ><?php echo $emp->name; ?></option>
	              		<?php endforeach; ?>
	              	<?php endif; ?>	
	              </select>	
	            </div>
	          ...
	          <div class="col-md-10">
	            <div class="form-group">
	                ...
	                <input id="form_name" type="text" name="start_date" class="form-control" placeholder="START YYYY-MM-DD" value="<?php echo $slvl->date_start; ?>">
	            </div>
	          </div>
	        </div> 
	        <div class="row">
