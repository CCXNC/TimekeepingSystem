	    	 	...
	    	 	<div class="panel panel-primary">
                    ...
                    <th>Status</th>
                    		...
                    		$fixed_in = 450;
	                    		...
	                    		if($weekdate <= 4 && $holiday_dates != $ot->date_ot)
	                    		{
		                    	...
		                    	elseif($weekdate <= 4 && $holiday_dates == $ot->date_ot)
	                    		{
		                    		$ot_hr_holiday = intval($total_out_daily - $total_in_daily);
														$hr_diff = intval($ot_hr/60);
														$min_diff = intval($ot_hr%60);
														//$hrs1 = sprintf("%02d", $min_diff);
														//echo $hr_diff.".".$hrs1."";
														//$ot_nght = $ot_hr;
														$mon_fri_in = $ot_hr_holiday;
		                    	}	
			    	 		...
			    	 		<thead>
				          	...
				          	<?php if($employee_type->type == 'DP') : ?>	
					          	<td>
					          		<b>
					          			<?php if($cut_off) : ?>
					          				<?php $lh_plus_daily_hours = $total_daily_hours + $total_lh_day; ?>
					          				<?php $total_work_days = $cut_off->total_days - $total_sunday_date; ?>
						          			<?php echo $lh_plus_daily_hours . '/' . $total_work_days; ?>
						          		<?php endif; ?>
					          		</b>
					          	</td>
					          <?php endif; ?>	
