...
<div id="wrapper">
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="navbar-header">
            <a class="navbar-brand" href="<?php echo base_url(); ?>index.php/dashboard/dashboard">NHFC Time Keeping v2</a>
        </div>
        ...
        <ul class="nav navbar-right navbar-top-links">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                   ...
                   <!-- <li>
                        <a href="<?php echo base_url(); ?>index.php/csv_import/index_csv1"><i class="fa fa-file fa-fw"></i>CSV Branch</a>
                    </li> 
                    <li>
                        <a href="<?php echo base_url(); ?>index.php/payroll/set_cutoff_date"><i class="fa fa-clock-o fa-fw"></i>Cut-off Date</a>
                    </li> -->
                    <li>
