...
class Reports extends CI_Controller {
	...
	{
		$this->payroll_model->delete_slvl($id);
		$this->session->set_flashdata('delete_msg', 'SL/VL SUCCESSFULLY DELETED!');
		redirect('reports/index_slvl');
	}
	...
	public function edit_ob($id)
	{
		...
		else
		{
			...
			{
				$this->session->set_flashdata('update_msg', 'OB SUCCESSFULLY UPDATED!');
				redirect('reports/index_ob');
			}
		}
	...
	{
		$this->payroll_model->delete_ob($id);
